<h2><a href="https://leetcode.com/problems/valid-digit-number/description/">4286. Valid Digit Number</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code> and a digit <code>x</code>.</p>
